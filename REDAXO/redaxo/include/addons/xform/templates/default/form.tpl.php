<div id="<?php echo $this->objparams['form_wrap_id'] ?>" class="xform">
    ...
    <form action="<?php echo $this->objparams['form_action'] ?>" method="<?php echo $this->objparams['form_method'] ?>" id="<?php echo  $this->objparams['form_id'] ?>" class="form-horizontal <?php echo $this->objparams['form_class'] ?>" enctype="multipart/form-data">
